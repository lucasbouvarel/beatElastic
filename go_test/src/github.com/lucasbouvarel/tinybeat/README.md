...
`${GOPATH}/src/github.com/lucasbouvarel/tinybeat`
...
```
git remote set-url origin https://github.com/lucasbouvarel/tinybeat
...
in the same directory with the name tinybeat.
...
```
mkdir -p ${GOPATH}/src/github.com/lucasbouvarel/tinybeat
git clone https://github.com/lucasbouvarel/tinybeat ${GOPATH}/src/github.com/lucasbouvarel/tinybeat
```
